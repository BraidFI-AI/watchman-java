...
Before responding:
- Read `@.claude/context.md` and treat it as the authoritative source of truth for security requirements.
- Use `@docs/decisions/decisions.md` for historical context and rationale related to security.
