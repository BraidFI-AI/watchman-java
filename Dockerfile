...
# Install Python for API generation scripts
...
RUN echo '#!/bin/sh' > /app/start.sh && \
    ...
    echo '  # Switch to appuser and start Java web server' >> /app/start.sh && \
