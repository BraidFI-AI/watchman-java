...
import io.braid.daywatcher.model.Address;
 ...
 * Tests for address normalization and comparison - Now uses Spring bean injection
 * 
 ...
 * 
 * AddressComparer is now a Spring-managed bean with config injection.
 */
@SpringBootTest
