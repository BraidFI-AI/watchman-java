package io.braid.daywatcher.trace;
...
class TracingMergeValidationIntegrationTest {
    ...
    class InfrastructureTests {
        ...
        void scoringContextExists() {
            assertDoesNotThrow(() -> Class.forName("io.braid.daywatcher.trace.ScoringContext"),
        ...
        void disabledContextExists() {
            assertDoesNotThrow(() -> Class.forName("io.braid.daywatcher.trace.DisabledScoringContext"),
        ...
        void enabledContextExists() {
            assertDoesNotThrow(() -> Class.forName("io.braid.daywatcher.trace.EnabledScoringContext"),
        ...
        void phaseEnumExists() {
            assertDoesNotThrow(() -> Class.forName("io.braid.daywatcher.trace.Phase"),
        ...
        void scoringEventExists() {
            assertDoesNotThrow(() -> Class.forName("io.braid.daywatcher.trace.ScoringEvent"),
        ...
        void scoringTraceExists() {
            assertDoesNotThrow(() -> Class.forName("io.braid.daywatcher.trace.ScoringTrace"),
