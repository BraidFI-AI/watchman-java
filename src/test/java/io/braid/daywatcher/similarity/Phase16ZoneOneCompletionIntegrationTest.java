...
import io.braid.daywatcher.search.ContactFieldAdapter;
import io.braid.daywatcher.search.ContactFieldMatch;
import io.braid.daywatcher.search.DebugScoring;
...
class Phase16ZoneOneCompletionIntegrationTest {
    ...
    @Autowired
    private io.braid.daywatcher.config.WeightConfig weightConfig;
