...
public class SearchController {
    ...
    public SearchController(SearchService searchService, EntityIndex entityIndex, EntityScorer entityScorer, io.braid.daywatcher.trace.TraceRepository traceRepository, WeightConfig weightConfig) {
