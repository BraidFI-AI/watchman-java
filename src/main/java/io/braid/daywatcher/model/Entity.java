...
import io.braid.daywatcher.normalize.PhoneNormalizer;
import io.braid.daywatcher.scorer.AddressNormalizer;
import io.braid.daywatcher.similarity.LanguageDetector;
...
public record Entity(
    ...
    public Entity normalize() {
        return normalize(new LanguageDetector(new io.braid.daywatcher.config.SimilarityConfig()), new TextNormalizer());
    }
