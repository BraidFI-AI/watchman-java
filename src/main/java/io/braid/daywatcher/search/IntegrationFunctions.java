...
public class IntegrationFunctions {
    ...
    public static ScorePiece compareEntityDates(Entity query, Entity index, double weight,
                                                io.braid.daywatcher.scorer.DateComparer dateComparer) {
        io.braid.daywatcher.scorer.DateComparer.DateComparisonResult result = switch (query.type()) {
            case PERSON -> {
                if (query.person() == null || index.person() == null) {
                    yield new io.braid.daywatcher.scorer.DateComparer.DateComparisonResult(0.0, false, 0);
                }
            ...
            default -> new io.braid.daywatcher.scorer.DateComparer.DateComparisonResult(0.0, false, 0);
        };
