...
public interface SimilarityService {
     ...
     */
    default double tokenizedSimilarity(String s1, String s2, ScoringContext ctx) {
        return tokenizedSimilarity(s1, s2);
    }
     ...
     */
    default double tokenizedSimilarityWithPrepared(String normalizedQuery, java.util.List<String> preparedNames, ScoringContext ctx) {
        return tokenizedSimilarityWithPrepared(normalizedQuery, preparedNames);
    }
